...
<Figure src="ws-graph-1.png" alt="Runtime vs. thread count for word scoring" caption="Runtime vs. thread count for word scoring" />

<Figure src="wg-graph-1.png" alt="Runtime vs. thread count for word generation" caption="Runtime vs. thread count for word generation" />
