...
<Figure src="team.jpg" alt="The team" caption="The team" />
...
<Figure src="system-sketch.png" alt="Sketch planning system design" caption="Sketch planning system design" />
...
<Figure src="inventor.png" alt="Autodesk Inventor CAD model" caption="Autodesk Inventor CAD model" />
...
<Figure src="wiring.jpg" alt="Wiring the arduino" caption="Wiring the arduino" />
...
<Figure src="construction.jpg" alt="Assembling the scale" caption="Assembling the scale" />
...
<Figure src="programming.jpg" alt="Programming the scale" caption="Programming the scale" />

## Results

<Figure src="testing.jpg" alt="The testing process" caption="The testing process" />
...
<Figure src="graph.png" alt="Graph of trash vs. time" caption="Graph of trash vs. time" />
